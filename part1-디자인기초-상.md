...
> **SPEC 4기 디자인팀 전용 교육자료**
> 본 자료는 디자인을 전공하지 않은 분이 실무에서 쓸 수 있는 수준까지 빠르게 올라가기 위해 제작되었습니다.
> 이론보다 감각, 감각보다 원칙. 원칙을 알면 AI 도구도 제대로 활용하실 수 있습니다.
...
디자인을 완성하고 나서 이 체크리스트로 점검해보시기 바랍니다.

### ✅ 원칙 1. Contrast (대비)
- [ ] 가장 중요한 정보가 한눈에 보이는가?
- [ ] 제목과 본문의 크기 차이가 충분한가? (최소 1.5배 이상)
- [ ] 비슷해 보이는 요소들이 의도치 않게 비슷한 건 아닌가?
- [ ] 배경과 텍스트의 색상 대비가 충분한가? (읽기 어렵지 않은가?)

### ✅ 원칙 2. Repetition (반복)
- [ ] 폰트가 2~3가지 이내로 통일되어 있는가?
- [ ] 강조 색상이 일관되게 사용되고 있는가?
- [ ] 시리즈물이라면 반복되는 시각 요소가 있는가?
- [ ] 아이콘이나 그래픽 스타일이 통일되어 있는가?

### ✅ 원칙 3. Alignment (정렬)
- [ ] 임의로 배치된 요소가 없는가?
- [ ] 보이지 않는 정렬선이 최소화되어 있는가?
- [ ] 긴 본문 텍스트가 좌측 정렬되어 있는가?
- [ ] 요소들이 서로 시각적으로 연결되어 있는가?

### ✅ 원칙 4. Proximity (근접)
- [ ] 관련 있는 정보들이 가까이 묶여 있는가?
- [ ] 그룹과 그룹 사이에 충분한 여백이 있는가?
- [ ] 이미지와 그 설명이 가까이 있는가?
- [ ] 정보를 파악하는 데 전체를 다 읽어야 하는가? (그렇다면 그룹핑 필요)

---

> **한 줄 요약**
> 대비는 과감하게, 반복은 일관되게, 정렬은 선에 맞게, 근접은 그룹으로. 이 네 가지만 지켜도 디자인이 달라집니다.
...
디자인을 완성하고 나서 이 질문들을 점검해보시기 바랍니다.

### 시각적 위계
- [ ] 가장 중요한 정보가 가장 먼저 보이는가?
- [ ] 1순위 → 2순위 → 3순위 순서가 명확한가?
- [ ] 크기, 굵기, 색상으로 위계가 만들어져 있는가?

### 시선 흐름
- [ ] 포스터라면 Z패턴을 고려했는가?
- [ ] 중요한 정보가 왼쪽 또는 상단에 있는가?
- [ ] 눈이 자연스럽게 흐르는가, 아니면 헤매는가?

### 여백
- [ ] 빈 공간을 억지로 채우려 하지 않았는가?
- [ ] 텍스트 주변에 충분한 여백이 있는가?
- [ ] 가장자리에서 충분히 안쪽에서 시작하는가?

### 구도
- [ ] 이 디자인의 목적에 맞는 구도를 선택했는가?
- [ ] 요소들이 그리드에 맞춰 정렬되어 있는가?
- [ ] 전체적으로 균형이 잡혀 있는가?

---

> **한 줄 요약**
> 눈이 가는 순서를 설계하시기 바랍니다. 여백은 낭비가 아니라 디자인입니다. 구도는 목적에 맞게 선택하면 됩니다.
