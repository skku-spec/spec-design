...
> 4. 나노바나나 (Hailuo AI) — AI 이미지/영상 생성
...
**공식 사이트**: https://hailuoai.video

> 텍스트 설명만으로 사실적인 인물, 제품, 배경 이미지와 영상을 만들어주는 AI 생성 도구입니다.

![나노바나나 메인 페이지](tool-hailuo.png)

나노바나나는 Hailuo AI를 기반으로 한 AI 이미지·영상 생성 서비스입니다. 원하는 장면을 글로 설명하면 실제 사진처럼 보이는 이미지나 짧은 영상을 만들어 줍니다. 특히 인물의 표정과 감정 표현이 업계 최고 수준으로 평가받고 있어, 포스터나 홍보물에 쓸 인물 이미지를 만들 때 매우 유용합니다.
